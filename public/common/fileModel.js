        ...
        link : function(scope, element, attrs) {
            ...
            element.bind('change', function(){
                scope.$apply(function(){
                    ...
                    // console.log("file from filemodel cutom drctve: "+element[0].files);
                    // console.log("file from filemodel cutom drctve: "+element[0]);
                    // console.log("file from filemodel cutom drctve: "+element[0].file[0]);;
